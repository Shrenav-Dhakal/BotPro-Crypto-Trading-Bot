...
class BinanceFuturesClient:
    ...
    def _start_ws(self):
        self._ws = websocket.WebSocketApp(self._wssurl, on_open=self._on_open, on_close=self._on_close, on_error=self._on_error, on_message=self._on_message)
    ...
    def _on_open(self,ws):
        logger.info("Binance testnet connection opened")

        self.subscribe_channel(list(self.contracts.values()), "bookTicker")
        self.subscribe_channel(list(self.contracts.values()), "aggTrade")

    def _on_close(self,ws):
        logger.warning("Binance testnet connection closed")

    def _on_error(self,ws,msg: str):
        logger.error("Binance testnet connection: %s",msg)
